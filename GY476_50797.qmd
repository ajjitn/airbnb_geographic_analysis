...
The disadvantages of these new spatial datasets are that they are subject to many biases, often do not contain measures of uncertainty, and may violate the privacy of individuals and allow people to reidentify individuals. In the case of Airbnb data for example, we only have pricing data on the small sliver of the rental market that chooses to upload their listings to Airbnb, and is not at all representative of the larger housing, or even tourist/rental market. Furthermore, while Airbnb does some validation, it is not comprehensive and it is entirely possible that this data include fake listings which would skew the data considerably. 
